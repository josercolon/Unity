...
public class TextControler : MonoBehaviour {
	...
	private enum States {
		...
		pin_0, closet_0,  stairs_0, stairs_1, stairs_2, courtyard, floor, 
	...
	void corridor_0 () {
		text.text = "You get out of the cell, you get to a corridor, at the end " +
					"of the corridor there is a staircase and on the other end " +
					"there is a closet. There is also some things on the floor. \n\n" +
					"Press S to Go up the Stairs, C to go to the closet " +
					"or F to inspect the things on the Floor";
